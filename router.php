<?php
    ...
    use controller\DirCreatorController;
    ...
    header("Access-Control-Allow-Headers: Access-Control-Allow-Origin, Content-Type, Content-Length, Access-Control-Allow-Headers, X-Requested-With, Access-Control-Allow-Methods");
    ...
    switch ($uri[3]) {
        ...
        case 'service':
            ...
            break;
        case 'directories':
            $dirCreatorController = new DirCreatorController($id, $requestMethod);
            $dirCreatorController->processRequest();
            break;
        default:
